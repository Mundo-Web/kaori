...
const Address = ({ generals, details }) => {
      ...
      <div className="w-full max-w-7xl mx-auto p-[5%] mt-16 font-sans">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            {em(details?.['messages.title'] ?? '¡Siempre estamos *pendiente* de usted!')}
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {em(details?.['messages.description'] ?? 'Puede llamarnos en horario laboral o visitar nuestra oficina. Todos los correos electrónicos recibirán respuesta en un plazo de 24 horas. ¡Nos encantaría saber de usted!')}
          </p>
        </div>
